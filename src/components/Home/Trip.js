...
class Trip extends React.Component {
  ...
  render() {
    ...
    const { img_url, driver, start_trip, end_trip, destination, plate } = trip;
    return (
      <>
        <div>
          <div className="trip-card-parent">
            ...
            <div className="trip-card-arrow">
              ...
              <div
                ...
                onClick={() => handleMapModalVisibility(true, trip)}
              >
                VIEW ROUTE >
              </div>
            </div>
            ...
            {this.isTripFinished(trip) ? (
              <div className="trip-card-end-trip">
                <div id="completed-trip-text">
                  <FontAwesomeIcon icon={faCheck} color={"#73b504"} /> Completed
                </div>
              </div>
            ) : (
              <>
                <div className="trip-card-start-trip">
                  <div
                    ...
                    onClick={() =>
                      this.editModalVisibilityHelper(true, trip, "start")
                    }
                  >
                    START TRIP
                  </div>
                ...
                <div className="trip-card-end-trip">
                  ...
                  <div
                    ...
                    onClick={() =>
                      this.editModalVisibilityHelper(true, trip, "end")
                    }
                  >
                    END TRIP
                  </div>

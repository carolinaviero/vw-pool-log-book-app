        ...
        return (
            <>
                <div className="success-container">
                    ...
                    <h2>
                        {this.props.trip.driver}, you're taking{" "}
                        {this.props.trip.plate} on{" "}
                        {moment(this.props.trip.start_trip).format("D MMM YYYY")} at{" "}
                        {moment(this.props.trip.start_trip).format("H:mm")}
                    </h2>
